...
from services.product_branch import get_all_product_branch, group_products_branch, modify_stock_of_product, delete_product_branch, get_one_product_branch
...
@product_branch_router.get('/product-branch/{sku_product}/{pc_branch}')
async def delete_product_branch_by_api(sku_product: str, pc_branch: str, session: Session = Depends(get_session)):
...
async def update_stock_product_branch(sku_product: str, pc_branch: str, product_branch_stock: ProductBranchUpdate, session: Session = Depends(get_session)):
    product_branch = modify_stock_of_product(session, sku_product, pc_branch, product_branch_stock.stock)
...
@product_branch_router.delete('/product-branch/{sku_product}/{pc_branch}')
async def delete_product_branch_by_api(sku_product: str, pc_branch: str, session: Session = Depends(get_session)):
    product_branch = delete_product_branch(session, sku_product, pc_branch)
